...
const Sidebar = () => {
    ...
    return (
        <div className="w-64 h-screen bg-[#FFF0F3] shadow-lg flex flex-col  items-center py-2">
            {/* Logo */}
            ...
            <ul className="space-y-5 text-sm font-semibold text-gray-700 w-full px-8">
                <li className="flex items-center space-x-3 hover:text-purple-400 cursor-pointer"
                ...
                <li className="flex items-center space-x-3 hover:text-red-500 cursor-pointer "
                onClick={()=> navigate('/')}>
