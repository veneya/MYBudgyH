...
const ProfilePhotoSelector = ({ onChange }) => {
    ...
    return (
        <div className="relative flex flex-col items-center">
            ...
            <div
                className="w-28 h-28 rounded-full bg-gray-200 flex items-center justify-center cursor-pointer border-2 border-gray-300 hover:border-pink-400 transition-all overflow-hidden"
            ...
            {/* small upload badge */}
            <div
                className="absolute bottom-0 right-1 bg-pink-500 text-white rounded-full p-1 cursor-pointer shadow"
                onClick={() => setShowOptions(!showOptions)}
            >
                <LuUpload size={12} />
            </div>
